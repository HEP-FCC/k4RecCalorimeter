...
pgun1_electron.ThetaMin = 0.5 * _pi / 180.0
pgun1_electron.ThetaMax = 1.5 * _pi / 180.0
...
pgun2_pion.ThetaMin = 80 * _pi / 180.0
pgun2_pion.ThetaMax = 100 * _pi / 180.0
...
saveecalbarreltool = SimG4SaveCalHits(
    "saveECalBarrelHits", readoutNames=[ecalBarrelReadoutName]
)
...
saveecalendcaptool = SimG4SaveCalHits(
    "saveECalEndcapHits", readoutNames=[ecalEndcapReadoutName]
)
...
savehcalendcaptool = SimG4SaveCalHits(
    "saveHCalEndcapHits", readoutNames=[hcalEndcapReadoutName]
)
...
iosvc = IOSvc()
iosvc.Output = "output_fullCalo_SimAndDigi_e50GeV_" + str(num_events) + "events.root"
