...
ECalBcells = CellPositionsECalBarrelTool(
    "CellPositionsECalBarrel", readoutName=ecalBarrelReadoutName
)
...
dummyCells = CellPositionsDummyTool("CellPositions", OutputLevel=INFO)
...
barrelHcalGeometry = LayerPhiEtaCaloTool(
    "BarrelHcalGeo",
    readoutName="BarHCal_Readout_phieta",
...
out.outputCommands = [
    ...
    "keep splitCaloClusters",
    "keep splitCaloClusterCells",
