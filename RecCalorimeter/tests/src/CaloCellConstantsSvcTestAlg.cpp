...
class CaloCellConstantsSvcTestAlg : public Algorithm {
public:
...
private:
  ServiceHandle<ICaloCellConstantsSvc> m_svc{this, "CaloCellConstantsSvc", "k4::recCalo::CaloCellConstantsSvc", ""};
};
...
StatusCode CaloCellConstantsSvcTestAlg::execute() { return StatusCode::SUCCESS; }
