...
public:
   ...
   * deltaThetaTower').
   *   @return Array containing number of towers in theta and phi.
   */
...
private:
  ...
  /// Handle for cell positions tool in ECalBarrel
  ToolHandle<ICellPositionsTool> m_cellPositionsECalBarrelTool{"CellPositionsECalBarrelModuleThetaSegTool", this};
  ...
  /// Radius used to calculate cluster position from theta and phi (in mm)
