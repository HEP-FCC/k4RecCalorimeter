...
correctCaloClusters = CorrectCaloClusters("correctCaloClusters",
                                          ...
                                          benchmarkTwoFormulas = False,
                                          benchmarkEneSwitch = 5.,
                                          upstreamCorr = False,
...
out.filename = "./root/output_evts_" + str(Nevts) + "_pdg_" + str(pdgCode) + "_pMin_" + str(momentum) + "_GeV" + "_ThetaMinMax_" + str(thetaMin) + "_" + str(
