...
guntool.ThetaMin = 45 * constants.pi / 180.0
guntool.ThetaMax = 135 * constants.pi / 180.0
guntool.PhiMin = 0.0
guntool.PhiMax = 2.0 * constants.pi
guntool.MomentumMin = 1.0 * units.GeV
guntool.MomentumMax = 1.0 * units.GeV
...
detectors = ["FCCee/ALLEGRO/compact/ALLEGRO_o1_v01/ALLEGRO_o1_v01.xml"]
...
calibEcalBarrel.samplingFraction = (
    [0.3632447480841956] * 1
    + [0.13187261040190248] * 1
    + [0.14349714292943705] * 1
    + [0.150266118277841] * 1
    + [0.15502683375826457] * 1
    + [0.15954408786354762] * 1
    + [0.16375302347299436] * 1
    + [0.16840384714588075] * 1
    + [0.17219540619311383] * 1
    + [0.1755068643940401] * 1
    + [0.17816980262822366] * 1
    + [0.18131266048670405] * 1
)
...
towers.deltaPhiTower = 2 * constants.pi / 768.0
...
createEcalBarrelPositionedCaloClusterCells.positionedHits.Path = (
    "PositionedCaloClusterCells"
)
...
correctCaloClusters.upstreamParameters = [
    [
        0.033955208567442975,
        -3.818122686176795,
        -146.59497297249345,
        0.563447903447204,
        -3.7906629536351906,
...
correctCaloClusters.downstreamParameters = [
    [
        -0.00357017357914002,
        0.006624434345822984,
        1.0065650241358008,
        -1.285181650875406,
        -0.0707783194915608,
        12.907319280196257,
