 ...
 */
#ifndef RECCALOCOMMON_ICALIBRATECALOHITSTOOL_H
#define RECCALOCOMMON_ICALIBRATECALOHITSTOOL_H
...
public:
  ...
  virtual void calibrate(std::unordered_map<CellID, double>& aHits) const = 0;
