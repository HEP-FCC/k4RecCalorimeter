...
void test2() {
  ...
  std::vector<FieldDesc_t> fieldDescs{
      FieldDesc_t(std::min(bfe_side->offset(), bfe_wheel->offset()), bfe_side->width() + bfe_wheel->width()),
      IDMap_t::makeDesc(*desc.field("rho")), IDMap_t::makeDesc(*desc.field("z")),
      IDMap_t::makeDesc(*desc.field("module"))};
  std::vector<FieldDesc_t> ignoredDescs{IDMap_t::makeDesc(*desc.field("layer"))};
