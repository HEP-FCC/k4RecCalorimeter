...
geoservice = GeoSvc("GeoSvc", OutputLevel=WARNING)
...
ECalBcells = CellPositionsECalBarrelTool(
    "CellPositionsECalBarrel", readoutName=ecalBarrelReadoutNamePhiEta, OutputLevel=INFO
)
...
positionsEcalBarrel = CreateCellPositions(
    "positionsEcalBarrel",
...
positionsHcalBarrel = CreateCellPositions(
    "positionsHcalBarrel",
...
positionsHcalExtBarrel = CreateCellPositions(
...
positionsEcalEndcap = CreateCellPositions(
    "positionsEcalEndcap",
...
positionsHcalEndcap = CreateCellPositions(
    "positionsHcalEndcap",
...
positionsEcalFwd = CreateCellPositions(
    "positionsEcalFwd",
...
positionsHcalFwd = CreateCellPositions(
    "positionsHcalFwd",
...
io_svc.outputCommands = [
    "keep *",
    "drop ECalBarrelCells",
    "drop ECalEndcapCells",
    "drop ECalFwdCells",
    "drop HCalBarrelCells",
    "drop HCalExtBarrelCells",
    "drop HCalEndcapCells",
    "drop HCalFwdCells",
]
